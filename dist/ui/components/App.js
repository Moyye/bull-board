...
exports.App = ({ basePath }) => {
    var _a, _b;
    const { state, selectedStatuses, setSelectedStatuses, promoteJob, retryJob, retryAll, cleanJob, cleanAllDelayed, cleanAllFailed, cleanAllCompleted, } = useStore_1.useStore(basePath);
